...
def get_map(input_image, detect_resolution=384, image_resolution=512, bg_threshold=0.0):
    with torch.no_grad():
...
parser.add_argument('--start', type=int, default=0)  # start saving images from start.png
